...
-- delete survey records w/o data
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (19552, 20889, 21810, 22476, 22563, 22966, 23585)

-- delete erroneous survey & species records
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (21080, 21081, 21082)
-- SELECT * FROM tblNHBPSpeciesData WHERE ID IN (21080, 21081, 21082)

-- update survey record w/ missing date
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID = 24947

-- update survey records w/ missing loop
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID BETWEEN 34523 AND 34530

-- update survey records w/ erroneous station number
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (21029, 23880, 24418, 25323, 28882)

-- delete species records w/o ID
-- SELECT * FROM tblNHBPSpeciesData WHERE LID BETWEEN 5293 AND 5294 OR LID = 12586 OR LID BETWEEN 31996 AND 32002 OR LID BETWEEN 84281 AND 84286

-- insert species record from tblNHBPSpeciesDataOld
-- SELECT * FROM tblNHBPSpeciesData WHERE LID = 99534

-- update Discovery Park loop names
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE Site = 'Discovery Park' AND Loop = 'Beaches (N & S Combined)'
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE Site = 'Discovery Park' AND Loop = 'Daybreak Loop'
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE Site = 'Discovery Park' AND Loop = 'Eastern Loop'
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE Site = 'Discovery Park' AND Loop = 'Nike 500'
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE Site = 'Discovery Park' AND Loop = 'Northern Loop'
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE Site = 'Discovery Park' AND Loop = 'Southern Loop'

-- delete survey records for Discovery Beaches loop w/ station number >= 8
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (20786, 20953, 20977, 21030, 21126, 21192, 21234, 21293, 21342, 21392, 21866, 21984, 22151,
--        22223, 22279, 22762, 22974, 23180, 23242, 23243, 23265, 23266, 23299, 23460, 23501, 23575, 26759, 26556, 26603, 26611, 26619, 26627, 26635,
--        26643, 26701, 26859, 27244, 27401, 27574, 27892, 28130, 28465, 28651, 28835, 28898, 29103, 29292, 29655, 29715, 30139, 30279, 30324, 30398,
--        30459, 31276, 32331, 32569, 32632, 32760, 32813, 32943, 33108, 33198, 33327, 33372, 33501, 33855, 34004, 34144, 34251, 34735, 34751)
-- SELECT * FROM tblNHBPSpeciesData WHERE ID IN (20786, 20953, 20977, 21030, 21126, 21192, 21234, 21293, 21342, 21392, 21866, 21984, 22151, 22223, 22279,
--         22762, 22974, 23180, 23242, 23243, 23265, 23266, 23299, 23460, 23501, 23575, 26759, 26556, 26603, 26611, 26619, 26627, 26635, 26643, 26701,
--         26859, 27244, 27401, 27574, 27892, 28130, 28465, 28651, 28835, 28898, 29103, 29292, 29655, 29715, 30139, 30279, 30324, 30398, 30459, 31276,
--         32331, 32569, 32632, 32760, 32813, 32943, 33108, 33198, 33327, 33372, 33501, 33855, 34004, 34144, 34251, 34735, 34751)

-- update May 2005 survey records for North Bluff Loop to North Beach Trail loop
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (22732, 22733, 22734)

-- update June 2005 survey records for North Bluff Loop to North Beach Trail loop
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (22993, 22994, 22995, 22996)

-- update December 2005 survey records for North Bluff Loop to North Beach Trail loop
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (23421, 23422, 23423, 23424)

-- update April 2006 survey records for North Beach Trail to Beaches loop
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (24435, 24436, 24437, 24438, 24439, 24440, 24441)

-- update May 2006 survey records for North Beach Trail to Beaches loop, remove data for station 8
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (24356, 24357, 24358, 24359, 24360, 24361, 24362)
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID = 24363
-- SELECT * FROM tblNHBPSpeciesData WHERE ID = 24363

-- update June 2006 survey records for North Beach Trail to Beaches loop, remove data for station 8
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (24508, 24509, 24510, 24511, 24512, 24513, 24514)
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID = 24515
-- SELECT * FROM tblNHBPSpeciesData WHERE ID = 24515

-- update July 2006 survey records for North Beach Trail to Beaches loop, remove data for station 8
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (24578, 24579, 24580, 24581, 24582, 24583, 24584)
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID = 24585
-- SELECT * FROM tblNHBPSpeciesData WHERE ID = 24585

-- update August 2006 survey records for North Beach Trail to Beaches loop, remove data for station 8
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (24642, 24643, 24644, 24645, 24646, 24647, 24648)
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID = 24649
-- SELECT * FROM tblNHBPSpeciesData WHERE ID = 24649

-- update September 2006 survey records for North Beach Trail to Beaches loop, remove data for station 8
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (24776, 24777, 24778, 24779, 24780, 24781, 24782)
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID = 24783
-- SELECT * FROM tblNHBPSpeciesData WHERE ID = 24783

-- update October 2006 survey records for North Beach Trail to Beaches loop, remove data for station 8
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (24820, 24821, 24822, 24823, 24824, 24825, 24826)
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID = 24827
-- SELECT * FROM tblNHBPSpeciesData WHERE ID = 24827

-- update March 2004 survey records for South Bluff to South Loop Trail
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (21005, 21006, 21007, 21008, 21009, 21010, 21011, 21012, 21013)

-- update August 2005 survey records for South Bluff to South Meadow
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (23191, 23192, 23193, 23194, 23195, 23196, 23197, 23198, 23199)

-- update June 2006 survey records for South Loop Trail to Eastern Edge
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (24516, 24517, 24518, 24519, 24520, 24521, 24522, 24523, 24524)

-- delete erroneous duplicate station 7 data for May 2012 South Beach Trail survey
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID = 34095
-- SELECT * FROM tblNHBPSpeciesData WHERE ID = 34095

-- delete erroneous duplicate stations & data for September 2005 Beaches survey
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (23235, 23236, 23237, 23238, 23239, 23240, 23241)
-- SELECT * FROM tblNHBPSpeciesData WHERE ID IN (23235, 23236, 23237, 23238, 23239, 23240, 23241)

-- update erroneous station data for September 2005 Beaches survey
-- SELECT * FROM tblNHBPSpeciesData WHERE LID = 36872

-- delete erroneous station data for September 2005 Beaches survey
-- SELECT * FROM tblNHBPSpeciesData WHERE LID = 36881

-- update remaining North Bluff Loop surveys to Hidden Valley Trail
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE Site = 'Discovery Park' AND Loop = 'North Bluff Loop'

-- update November 2004 survey records for South Bluff to South Beach Trail and set observers to Martha Taylor & Barbara Webster
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (21852, 21853, 21854, 21855, 21856, 21857, 21858)

-- update December 2004 survey records for South Bluff to South Beach Trail and set observer to Barbara Webster
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (21923, 21924, 21925, 21926, 21927, 21928, 21929)

-- update January 2005 survey records for South Bluff to South Beach Trail and set observer to Barbara Webster
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (21970, 21971, 21972, 21973, 21974, 21975, 21976)

-- update February 2005 survey records for South Bluff to South Beach Trail
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (22152, 22153, 22154, 22155, 22156, 22157, 22158)

-- update March 2005 survey records for Beaches to South Beach Trail
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (22183, 22184, 22185, 22186, 22187, 22188, 22189)

-- update April 2005 survey records for South Bluff to South Beach Trail
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (22280, 22281, 22282, 22283, 22284, 22285, 22286)

-- update August 2008 survey records for Discovery - South Loop Trail to Magnuson - Southend Loop
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (27800, 27801, 27802, 27803, 27804)

-- update October 2008 survey records for South Meadow to Eastern Edge
-- SELECT * FROM tblNeighborhoodBirdProjectData WHERE ID IN (28210, 28211, 28212, 28213, 28214, 28215, 28216, 28217, 28218)

-- update erroneous American Black Duck record to American Crow
-- SELECT * FROM tblNHBPSpeciesData WHERE LID = 31814




-- SELECT DISTINCT Loop, Year(SurveyDate), Month(SurveyDate), Observer1, MAX(Station) FROM tblNeighborhoodBirdProjectData a
-- WHERE Site = 'Discovery Park' AND Loop IN ('South Bluff', 'Eastern Edge', 'South Beach Trail') GROUP BY Year(SurveyDate), Month(SurveyDate), Loop, Observer1 ORDER BY Year(SurveyDate), Month(SurveyDate), Loop

-- SELECT * FROM tblNeighborhoodBirdProjectData a
-- JOIN tblNHBPSpeciesData b ON a.ID = b.ID
-- WHERE Site = 'Discovery Park'
-- AND SurveyDate LIKE '2008-10%' ORDER BY SurveyDate, Loop, Station
-- AND (Loop = 'Hidden Valley Trail' OR Loop = 'North Bluff Loop') ORDER BY SurveyDate, ID

-- SELECT * FROM tblNeighborhoodBirdProjectData a
-- WHERE Observer1 = 'Marilyn Sandall' ORDER BY SurveyDate, Station

--SELECT Month(SurveyDate), Loop, Observer1, MAX(Station) FROM tblNeighborhoodBirdProjectData a
--WHERE Site = 'Magnuson' AND Year(SurveyDate) = 2008 GROUP BY Month(SurveyDate), Loop, Observer1 ORDER BY Month(SurveyDate), Loop, Observer1

-- SELECT * FROM tblNeighborhoodBirdProjectData a
-- JOIN tblNHBPSpeciesData b ON a.ID = b.ID
-- WHERE Species = 'American Black Duck'